...
const ConfirmEmailChangePage: I18nPage<PageProps> = (props) => {
...
ConfirmEmailChangePage.getInitialProps = ({ query, store }: NextPageContext) => {
...
export default connector(withTranslation(includeDefaultNamespaces())(ConfirmEmailChangePage))
