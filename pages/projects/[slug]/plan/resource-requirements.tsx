...
const ProjectResourceRequirementsPage: I18nPage<PageProps> = ({ isMember, project, request, t, updateProject }) => {
...
ProjectResourceRequirementsPage.getInitialProps = ({ store, query }: NextPageContext) => {
