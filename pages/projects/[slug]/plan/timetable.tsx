...
const ProjectTimetablePage: I18nPage<PageProps> = ({ isMember, project, request, t, updateProject }) => {
  ...
  return <BaseLayout pageTitle={t("page.projects.plan.timetable.title")}>
    <Row>
      <Col>
...
ProjectTimetablePage.getInitialProps = ({ store, query }: NextPageContext) => {
...
export default withAuth(
  connector(
    withTranslation(includeDefaultNamespaces())(ProjectTimetablePage),
  ),
  UserRole.USER,
)
